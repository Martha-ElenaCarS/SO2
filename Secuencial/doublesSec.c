...
void Read_matrix (char *prompt, double *matrix, int n);
void Print_matrix (char *prompt, double *matrix, int n);
...
int main(int argc, char* argv[]) {
    ...
    if (my_rank == 0) {
		...
		matrix_A = (double *) malloc (MAX*MAX*sizeof(double));
		matrix_B = (double *) malloc (MAX*MAX*sizeof(double));
		matrix_C = (double *) malloc (MAX*MAX*sizeof(double));
