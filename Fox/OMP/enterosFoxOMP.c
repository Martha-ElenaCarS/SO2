/* fox.c -- Usa el algoritmo de Fox para multiplicar dos matrices cuadradas
 La raiz cuadrada del número de procesadores debe ser divisible por el orden de las matrices */
...
int main(int argc, char* argv[]) {
    ...
    FILE *file2;
    file2 = fopen("datosMemoria.txt","ab+");
    if(file2 != NULL){
